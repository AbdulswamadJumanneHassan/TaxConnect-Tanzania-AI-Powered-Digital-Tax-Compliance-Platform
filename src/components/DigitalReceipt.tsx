            ...
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-start">
                                ...
                                <div key={item.id} className="flex gap-3 items-end">
                                    <div className="flex-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-white/50 border border-white/20 rounded-xl px-4 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary"
                                        />
                                    </div>
                                    <div className="w-24">
                    ...
                    <div className="relative">
                        <div className="bg-white text-slate-900 p-8 rounded-lg shadow-2xl min-h-[500px] flex flex-col font-mono">
                                    ...
                                    <tbody>
                                        {items.map((item) => (
                                            <tr key={item.id} className="border-b border-slate-50">
                                                ...
                                                <td className="text-right py-2">{(item.price * item.qty).toLocaleString()}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                            ...
                            <div className="mt-8 flex flex-col items-center">
                                <div className="bg-white p-2 border border-slate-200 rounded-lg mb-4">
                                    <QRCodeSVG value={`https://smarttax.co.tz/receipt/${Date.now()}`} size={100} />
                                </div>
